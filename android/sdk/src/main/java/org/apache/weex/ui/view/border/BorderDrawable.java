 ...
 shadow. */
  ...
  public void setBorderRadius(CORNER position, float radius) {
    ...
    if (mBorderRadius.get(position) != radius ||
        (position == CORNER.ALL &&
            (radius != mBorderRadius.get(CORNER.BORDER_TOP_LEFT) ||
            radius != mBorderRadius.get(CORNER.BORDER_TOP_RIGHT) ||
            radius != mBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT) ||
            radius != mBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT)))) {
  ...
  float[] getBorderRadius(RectF borderBox) {
    ...
    float topLeftRadius = mOverlappingBorderRadius.get(CORNER.BORDER_TOP_LEFT);
    float topRightRadius = mOverlappingBorderRadius.get(CORNER.BORDER_TOP_RIGHT);
    float bottomRightRadius = mOverlappingBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT);
    float bottomLeftRadius = mOverlappingBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT);
  ...
  public boolean isRounded() {
    return mBorderRadius != null &&
            (mBorderRadius.get(CORNER.BORDER_TOP_LEFT) != 0 ||
                mBorderRadius.get(CORNER.BORDER_TOP_RIGHT) != 0 ||
                mBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT) != 0 ||
                mBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT) != 0);
  }
  ...
  private void prepareBorderRadius(@NonNull RectF borderBox) {
    if (mBorderRadius != null) {
      ...
      if (!Float.isNaN(factor) && factor < 1) {
        mOverlappingBorderRadius.set(CORNER.BORDER_TOP_LEFT,
            mBorderRadius.get(CORNER.BORDER_TOP_LEFT) * factor);
        mOverlappingBorderRadius.set(CORNER.BORDER_TOP_RIGHT,
            mBorderRadius.get(CORNER.BORDER_TOP_RIGHT) * factor);
        mOverlappingBorderRadius.set(CORNER.BORDER_BOTTOM_RIGHT,
            mBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT) * factor);
        mOverlappingBorderRadius.set(CORNER.BORDER_BOTTOM_LEFT,
            mBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT) * factor);
      } else {
        mOverlappingBorderRadius.set(CORNER.BORDER_TOP_LEFT,
            mBorderRadius.get(CORNER.BORDER_TOP_LEFT));
        mOverlappingBorderRadius.set(CORNER.BORDER_TOP_RIGHT,
            mBorderRadius.get(CORNER.BORDER_TOP_RIGHT));
        mOverlappingBorderRadius.set(CORNER.BORDER_BOTTOM_RIGHT,
            mBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT));
        mOverlappingBorderRadius.set(CORNER.BORDER_BOTTOM_LEFT,
            mBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT));
      }
    }
  }

  private float getScaleFactor(@NonNull RectF borderBox) {
    final float topRadius = mBorderRadius.get(CORNER.BORDER_TOP_LEFT)
            + mBorderRadius.get(CORNER.BORDER_TOP_RIGHT);
    final float rightRadius = mBorderRadius.get(CORNER.BORDER_TOP_RIGHT)
            + mBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT);
    final float bottomRadius = mBorderRadius.get(CORNER.BORDER_BOTTOM_RIGHT)
            + mBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT);
    final float leftRadius = mBorderRadius.get(CORNER.BORDER_BOTTOM_LEFT)
            + mBorderRadius.get(CORNER.BORDER_TOP_LEFT);
  ...
  private void drawBorders(Canvas canvas) {
    ...
    mTopLeftCorner.set(getBorderRadius(CORNER.BORDER_TOP_LEFT), leftBorderWidth, topBorderWidth, mRectBounds);
    if (mTopRightCorner == null) {
      mTopRightCorner = new TopRightCorner();
    }
    mTopRightCorner.set(getBorderRadius(CORNER.BORDER_TOP_RIGHT), topBorderWidth, rightBorderWidth, mRectBounds);
    if (mBottomRightCorner == null) {
      mBottomRightCorner = new BottomRightCorner();
    }
    mBottomRightCorner.set(getBorderRadius(CORNER.BORDER_BOTTOM_RIGHT), rightBorderWidth, bottomBorderWidth, mRectBounds);
    if (mBottomLeftCorner == null) {
      mBottomLeftCorner = new BottomLeftCorner();
    }
    mBottomLeftCorner.set(getBorderRadius(CORNER.BORDER_BOTTOM_LEFT), bottomBorderWidth, leftBorderWidth, mRectBounds);
