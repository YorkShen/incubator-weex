...
public class WXSDKInstance implements IWXActivityStateListener,View.OnLayoutChangeListener {
  ...
  private void checkWhiteScreen(){
    ...
    WXExceptionUtils
        .commitCriticalExceptionRT(getInstanceId(),errorCode,"checkEmptyScreen",errorCode.getErrorMsg(),args);
  }
  ...
  private void renderByUrlInternal(String pageName,
    ...
    wxRequest.paramMap.put(
        WXHttpUtil.KEY_USER_AGENT, WXHttpUtil.assembleUserAgent(mContext,WXEnvironment.getConfig()));
